...
#streamlit bar chart
st.title("Basic Bar Char - Jumlah Mahasiswa Per jurusan")
st.bar_chart(df.set_index('jurusan'))

#matplotlib bar chart
st.title("Basic Bar Chart Menggunakan Matplotlig")
fig, ax = plt.subplots()
...
ax.set_xlabel("Tahun")
ax.set_ylabel("Jumlah Mahasiswa")
ax.set_xticks([p + len(filter_jurusan) / 2 * width - width / 2 for p in x])
